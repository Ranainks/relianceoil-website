  ...
  return (
    <div>
      ...
      <section className="rs" style={{ backgroundColor: '#ffffff', position: 'relative', overflow: 'hidden' }}>
        ...
        <svg aria-hidden="true" style={{ position: 'absolute', top: '-80px', right: '-120px', maxWidth: '520px', width: '100%', height: '520px', opacity: 0.055, pointerEvents: 'none', zIndex: 0 }} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg aria-hidden="true" style={{ position: 'absolute', bottom: '-100px', left: '-100px', maxWidth: '480px', width: '100%', height: '480px', opacity: 0.07, pointerEvents: 'none', zIndex: 0 }} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg aria-hidden="true" style={{ position: 'absolute', top: '40%', right: '-60px', maxWidth: '280px', width: '100%', height: '280px', opacity: 0.04, pointerEvents: 'none', zIndex: 0 }} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg aria-hidden="true" style={{ position: 'absolute', top: '15%', left: '30%', maxWidth: '180px', width: '100%', height: '180px', opacity: 0.035, pointerEvents: 'none', zIndex: 0 }} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
