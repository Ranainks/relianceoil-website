      ...
      <div className="rc footer-grid" style={{ padding: '64px 24px', gap: '40px' }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <a href="mailto:info@relianceoilltd.com" style={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.6)', textDecoration: 'none' }} onMouseEnter={(e) => e.currentTarget.style.color = '#FFD700'} onMouseLeave={(e) => e.currentTarget.style.color = 'rgba(255,255,255,0.6)'}>info@relianceoilltd.com</a>
          </div>
